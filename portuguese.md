...
LinkedIn: _@pedrohenriquecordeiro_ | E-mail: _pedrohcordeiroj@gmail.com_ | GitHub: _@pedrohenriquecordeiro_

## Sobre mim

Sou Engenheiro de Dados com mais de 5 anos de experiência construindo soluções de dados escaláveis e confiáveis, com foco em performance, qualidade e impacto no negócio. Atuo do desenho à operação de pipelines e produtos de dados, garantindo que as informações cheguem com consistência, rastreabilidade e boa experiência para quem consome (BI, Analytics e times de produto).
...
**Mercantil do Brasil** · Remoto · 2021 – 2024

Construção e otimização de pipelines usando Python, PySpark, Airflow e Snowflake.
Automação de workflows e infraestrutura com Docker, Kubernetes e ferramentas da AWS e GCP.

### Estagiário em Análise de Dados

**Mercantil do Brasil** · Remoto · 2019 – 2021

Desenvolvimento de processos de ETL, dashboards (Power BI) e modelagem de dados em SQL e Python.
...
- Data Lakehouse com Delta & Iceberg (Engenharia de Dados Academy)
- Spark Streaming & PySpark (Alura)
